...
function Login() {
    ...
    return (
        <div style={{ minHeight: '100vh', backgroundColor: 'var(--bg-main)', color: 'var(--text-main)', display: 'flex', flexDirection: 'column', alignItems: 'center', paddingTop: '100px' }}>
            ...
            <h2 style={{ marginBottom: '30px' }}>Log Analyzer Sistemi</h2>

            <form onSubmit={handleLogin} style={{ width: '100%', maxWidth: '350px', padding: '30px', backgroundColor: 'var(--bg-card)', border: '1px solid var(--border-color)', borderRadius: '8px', boxShadow: '0 4px 6px rgba(0,0,0,0.1)' }}>
                ...
                <div style={{ marginTop: '20px', textAlign: 'center', fontSize: '14px', color: 'var(--text-muted)' }}>
                    Hesabın yok mu? <Link to="/register" style={{ color: 'var(--color-info)', textDecoration: 'none', fontWeight: 'bold' }}>Kayıt Ol</Link>
                </div>
            </form>
        </div>
    );
